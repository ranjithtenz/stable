...
# =====================================================================================
  ...
  def validate_for_items(self):
    ...
    for d in getlist(self.doclist, 'sales_order_details'):
      ...
      e = [d.item_code, d.reserved_warehouse, d.prevdoc_docname or '']
...
# ===============================================================================================
  ...
  def check_nextdoc_docstatus(self):
    ...
    if submit_ms:
      msgprint("Maintenance Schedule : " + cstr(submit_ms[0][0]) + " has already been submitted against this order!")
      raise Exception , "Validation Error."
    ...
    if submit_mv:
      msgprint("Maintenance Visit : " + cstr(submit_mv[0][0]) + " has already been submitted against this order!")
      raise Exception , "Validation Error."
