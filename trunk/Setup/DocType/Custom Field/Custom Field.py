class DocType:
  ...
  def get_fields_label(self):
    ...
    return NEWLINE.join(label_name)
...
# *************************** Validate *******************************
  ...
  def validate(self):
    ...
    # update the schema
    from webnotes.model.doctype import update_doctype
    import webnotes.model.doc
    webnotes.model.doctype.update_doctype(webnotes.model.doc.get('DocType',self.doc.dt, with_children=1))
