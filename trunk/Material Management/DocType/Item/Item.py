class DocType:
  ...
  def validate(self):
    ...
    #  msgprint("If Item is Sub Contracted Item then, it should not allow to make Production Order and Vice Versa. Refer Manufacturing section.")
    #  raise Exception
      
    if self.doc.is_pro_applicable == 'Yes' and self.doc.is_stock_item == 'No':
      msgprint("As Production Order can be made for this Item, then Is Stock Item Should be 'Yes' as we maintain it's stock. Refer Manufacturing and Inventory section.")
      raise Exception
